...
%
%   Desc: This solver searches for the global optimum of a nonlinear function 
%   f of n real variables x subject to nonlinear constraints c and bound 
%   constraints:
%
%                       ls <= c(x) <= us,
%                       lx <=   x  <= ux,
...
%   the SQP algorithm.
%
%   Author and maintainer of this software: 
%   Phillipe R. Sampaio (Veolia Research and Innovation)
...
%     - deft_funnel_init.m (entry parameters), 
%     - deft_funnel_problem_obj.m (objective function) 
%     - deft_funnel_problem_cons.m (constraint function(s)).
%
