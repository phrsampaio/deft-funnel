function output = problem_greybox_hesse_dev_f(x)
...
% Derivatives of the white-box objective function
gf = [-50*(x(1)-2) -2*(x(2)-2) -2*(x(3)-1) -2*(x(4)-4) -2*(x(5)-1) -2*(x(6)-4)];
Hf = [-50 0 0 0 0 0; 0 -2 0 0 0 0; 0 0 -2 0 0 0; 0 0 0 -2 0 0; 0 0 0 0 -2 0; 0 0 0 0 0 -2];
output = {gf, Hf};
