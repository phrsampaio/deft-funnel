function [ s, resn, exitc ] = deft_funnel_blls_exp( A, b, lb, ub, searchMethod )

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Desc: BLLS is a solver for bound-constrained linear least-squares problems, 
% that % is problem where, given 
% - a n x m matrix A,
...
% This version 22 September 2014.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%free  = find( stry )';                          % indices of free variables 
%atlb  = find( abs( max (s-g,lb)-s) <= epsfeas)'; % inds of vars at lower bound
%atub  = find( abs( min (s-g,ub)-s) <= epsfeas)'; % inds of vars at upper bound
