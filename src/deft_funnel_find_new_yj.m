function [ynew, improvement, msgTR] =                                       ...
    deft_funnel_find_new_yj(sample_set, j, setting, Delta)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Desc: Computes a point which is best to replace yj, the j-th (j>1) column of 
% Y (the base for the j-th polynomial) in a ball of radius Delta centered at 
% the first column of Y.  This is achieved by maximizing the absolute value of
