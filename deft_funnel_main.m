function [ exit_algo, nit, sampleSet, iterate, indicators, evaluations, models, ...
    xstatus, sstatus, vstatus, sspace_save,  xspace_save, const,            ...
    modelSize, Delta, Delta_f, Delta_c, vmax, msg, xlist, trlist ] =        ... 
        deft_funnel_main( f, c, nit, nitold, sampleSet, iterate,            ...
        setting, indicators, evaluations, models, xstatus, sstatus,         ...
        vstatus, sspace_save, xspace_save, const, modelSize,            	...
        Delta, Delta_f, Delta_c, Deltamax, vmax, poised_model, level)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Main routine of the algorithm DEFT-FUNNEL.
% This function is called by 'deft_funnel.m' and 'deft_funnel_ident_active_bnds.m'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
